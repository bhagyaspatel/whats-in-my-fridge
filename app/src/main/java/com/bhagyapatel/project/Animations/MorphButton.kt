package com.bhagyapatel.project.Animations
...
import com.bhagyapatel.project.Utils.dp
import com.bhagyapatel.project.Utils.getColorX
import com.bhagyapatel.project.Utils.getDrawableX
import com.bhagyapatel.project.Utils.sp
import com.google.android.material.math.MathUtils.lerp

class MorphButton @JvmOverloads constructor(context : Context, attrs : AttributeSet? = null, defStyle : Int = 0) : View(context, attrs, defStyle)
{
    ...
    var fromBgColor : Int = getColorX(R.color.button_orange)
    val toBgColor : Int = getColorX(R.color.button_green)
    val fromTextColor : Int = getColorX(R.color.white)
    val toTextColor : Int = getColorX(R.color.white)
    var btnRadius = 24 * dp()

    var iconDrawable = getDrawableX(R.drawable.ic_change_circle)
        set(value){
            field = value
            setSizeIcon()
        }
    ...
    private var uiState: UIState = MorphButton.UIState.Button
    ...
    private fun runAnimation(isReverse: Boolean): AnimatorSet {
        ...
        text = "Saved"
        fromBgColor = getColorX(R.color.button_green)
